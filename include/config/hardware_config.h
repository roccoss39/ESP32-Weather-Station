 ...
 */
 ...
 // UPDATE:
#define FIRMWARE_VERSION  1.40 // Zmien takze plik version.txt na te sama wersje
...
#define FIRMWARE_UPDATE_HOUR    03  // Godzina (Format 0-23)
#define FIRMWARE_UPDATE_MINUTE  15 // Minuta (Format 0-59)
