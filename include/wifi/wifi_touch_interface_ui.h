...
// Warstwa UI interfejsu dotykowego WiFi: rysowanie + obsługa interakcji dotykowych.
// Logika/stany są zarządzane przez wifi_touch_interface.cpp.
...
// Wizualne funkcje pomocnicze wywoływane z pętli logiki
