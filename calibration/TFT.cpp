...
void drawCross(int32_t x, int32_t y, uint16_t color);
...
void setup() {
  ...
  Serial.println("Starting TFT touch calibration...");

  // Initialize backlight - CRITICAL!
  pinMode(25, OUTPUT);
  ...
  // Set rotation to 0 (portrait) like in your working code
  tft.setRotation(1);

  // Test basic TFT first
  ...
  Serial.println("TFT test complete, starting calibration...");
