...
void setup() {
  ...
  //uint16_t calData[5] = { 350, 3267, 523, 3020, 1 }; plytka 1
  //uint16_t calData[5] = { 505, 3267, 422, 3241, 7 }; //plytka 2
  uint16_t calData[5] = { 449, 3415, 308, 3379, 7 }; //plytka 3
  ...
  defaultSSID = preferences.getString("ssid", "zero");
  defaultPassword = preferences.getString("password", "Qweqweqwe1");
